...
public class MiaoshaUserService {
	...
	public void updatePassword(String token,long id,String newPassword){
		MiaoshaUser userToBeUpdate = getById(id);
	  ...
	  userToBeUpdate.setPassword(MD5Util.formPass2DBPass(newPassword, userToBeUpdate.getSalt()));
	  //修改缓存
	  redisService.delete(MiaoshaUserKey.getById,""+id);
	  userToBeUpdate.setPassword(newPassword);
	  redisService.set(MiaoshaUserKey.token,token,userToBeUpdate);//不删除,
